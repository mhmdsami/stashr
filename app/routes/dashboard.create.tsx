  ...
  return (
    <EditorProvider
      ...
      editorProps={{
        attributes: {
          class:
            "text-xl h-[50vh] mx-10 focus:border-mint-600 focus:ring-mint-600 flex rounded-lg border border-gray-700 bg-zinc-900 px-3 py-2 text-sm transition-colors duration-200 ease-in-out focus:outline-none focus:ring-1",
        },
      }}
    >
